...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File your_file_name = File.createTempFile("temp", ".temp", new File("d://"));
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            outputStream.write((this.staticString + "\r\n").getBytes());
            outputStream.write((String.valueOf(this.i) + "\r\n").getBytes());
            outputStream.write((String.valueOf(this.j) + "\r\n").getBytes());
            outputStream.close();
        }
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            setStaticString(reader.readLine());
