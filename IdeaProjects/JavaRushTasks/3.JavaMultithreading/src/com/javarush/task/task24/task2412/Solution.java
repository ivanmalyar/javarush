...
public class Solution {
        ...
        Collections.sort(list, new Comparator<Stock>() {
            ...
            public int compare(Stock o1, Stock o2) {
                ...
                try {
                    ...
                    change1 = (double) o1.get("open") - (double) o1.get("last");
                }

                try {
                    change2 = (double) o2.get("change");
                } catch (NullPointerException e) {
                    change2 = (double) o2.get("open") - (double) o2.get("last");
                }
    ...
    public static List<Stock> getStocks() {
        ...
        //stocks.add(new Stock("Fake Microsoft Corporation", "MSFT", 29.0, 29.72));

        stocks.add(new Stock("Fake Nokia Corporation (ADR)", "NOK", .1, getRandomDate()));
        //stocks.add(new Stock("Fake Nokia Corporation (ADR)", "NOK", .9, getRandomDate()));
